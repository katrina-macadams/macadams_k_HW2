 ...
 */ !function(e, t) {
    ...
    function z(e) {
        ...
        var g = r || {
            ...
            width: 0,
            height: 0
        }, _ = g.x, y = g.y, x = g.width, m = g.height;
        ...
        else if ("polyline" === h || "polygon" === h) for(n = e.getAttribute("points").match(P) || [], "polygon" === h && n.push(n[0], n[1]), t = 0, o = 2; o < n.length; o += 2)t += u(n[o - 2], n[o - 1], n[o], n[o + 1], d, c) || 0;
    ...
    function A(e, t) {
        ...
        return i < 0 && (i = n.indexOf(" ")), t < (n = i < 0 ? t : q(n.substr(0, i))) && (n = t), [
            -s || 0,
            n - s || 0
        ];
    }
    ...
    var t, k, f, h, d, b, c, g, P = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, M = {
        ...
        init: function init(e, t, n) {
            ...
            return this.styles = c && c(e, "strokeDashoffset,strokeDasharray,strokeMiterlimit"), this.tween = n, this._style = e.style, this._target = e, t + "" == "true" ? t = "0 100%" : t ? -1 === (t + "").indexOf(" ") && (t = "0 " + t) : t = "0 0", i = function _parse(e, t, n) {
                var s, i, o = e.indexOf(" ");
                return i = o < 0 ? (s = void 0 !== n ? n + "" : e, e) : (s = e.substr(0, o), e.substr(o + 1)), s = r(s, t), (i = r(i, t)) < s ? [
                    i,
                    s
                ] : [
                    s,
        ...
        render: function render(e, t) {
            if (t.tween._time || !g()) {
                ...
                if (o) {
                    ...
                    s = t._dash || e && 1 !== e && 1e-4 || 0, r = t._length - s + .1, i = t._offset, s && i && s + Math.abs(i % t._length) > t._length - .2 && (i += i < 0 ? .1 : -0.1) && (r += .1), a.strokeDashoffset = s ? i : i + .001, a.strokeDasharray = r < .2 ? "none" : s ? s + "px," + (t._nowrap ? 999999 : r) + "px" : "0px, 999999px";
                }
...
//# sourceMappingURL=macadams_k_HW2.f07a25d1.js.map
